...
Uso: python transcribe_hf.py <file.wav|mp3> [lang]   lang default it-IT
"""
import sys, time, wave, contextlib
import torch
...
print(text)
print("====================")
print(f"[speed] audio={dur:.1f}s infer={infer:.2f}s RTF={infer/dur:.3f} lang={lang}")
